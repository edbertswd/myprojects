    ...
    <div className="portfolio-container">
      ...
      <header className="hero-section">
        <div className="hero-content">
          <h1 className="hero-title">Hi, I'm Edbert! </h1>
          <p className="hero-subtitle">I'm a Third Year Software Engineer Honours student at the University of Sydney. I am a recent
            software engineer intern at PT Bangunan Jaya Cemerlang and is looking to get into Cybersecurity, machine learning, and game development.
          </p>  
          <a href="#projects" className="cta-button">Explore My Work</a>
        </div>
        <div className="hero-image">
          <img src="/myface.png" alt="Hero Visual" />
        </div>
      </header>
        ...
        <section id="projects" className="projects-section">
          ...
          <div className="projects-grid">
            <div className="project-card fade-in">
              ...
              <p>Built with React, Node.js, and D3.js for real-time data visualizations.</p>
            ...
            <div className="project-card fade-in">
              ...
              <p>Designed a Pac-Man inspired game with custom AI behavior.</p>
              <button className="view-button">View Project</button>
            </div>
          </div>
        </section>
      ...
      <footer className="footer">
        <p>&copy; 2025 Edbert Tien Suwandi. All Rights Reserved.</p>
