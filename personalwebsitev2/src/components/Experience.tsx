            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-stretch gap-4">
                  <div
                    className="w-24 rounded-xl overflow-hidden flex items-center justify-center bg-white p-1.5 border border-border/50"
                  ...
                  <div>
                    <h2 className="text-2xl font-bold" style={{ color: "hsl(var(--slate))" }}>{experience.company}</h2>
                    <p className="text-base font-medium" style={{ color: "hsl(var(--muted-foreground))" }}>{experience.role}</p>
                    <div className="flex items-center gap-3 mt-1">
                      <span className="flex items-center gap-1 text-sm" style={{ color: "hsl(var(--taupe))" }}>
                ...
                <a
                  ...
                  className="flex items-center gap-1 text-sm font-medium hover:underline flex-shrink-0 mt-1 transition-colors duration-200 ease-out"
              ...
              <ul className="space-y-2 mb-4">
                {experience.bullets.map((bullet, index) => (
                  <li key={index} className="flex items-start gap-2">
                    ...
                    <span className="text-base leading-relaxed" style={{ color: "hsl(var(--foreground) / 0.75)" }}>{bullet}</span>
                  </li>
                ))}
              </ul>
              ...
              >
                <div className="p-4">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h3 className="text-lg font-bold mb-1" style={{ color: "hsl(var(--slate))" }}>{project.title}</h3>
                      <p className="text-sm mb-2" style={{ color: "hsl(var(--muted-foreground))" }}>{project.description}</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1 px-3 py-1 rounded-lg text-xs font-medium hover:shadow-sm hover:bg-sage hover:text-white transition-all duration-200 ease-out"
